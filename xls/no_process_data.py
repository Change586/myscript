...
def no_process_data(row_values,new_table,write_row_num):
    new_table.write(write_row_num,0,row_values[3])
    new_table.write(write_row_num,1,row_values[7])
    new_table.write(write_row_num,2,row_values[20])
    new_table.write(write_row_num,3,row_values[23])
